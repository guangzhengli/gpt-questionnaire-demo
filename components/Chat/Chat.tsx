...
import QuestionnaireForm from "@/components/Chat/QuestionnaireForm";
          ...
          <>
            ...
            >
              {(conversation.index?.indexName.length === 0) && (conversation.messages.length === 0) ? (
                <>
                  {(isUploadSuccess != undefined && !isUploadSuccess) ? (
                      <>
                ...
                <>
                  ...
                  <QuestionnaireForm indexName = {conversation.index?.indexName}/>
